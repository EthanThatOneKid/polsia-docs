...
Validation Core Requirement: Customer discovery.

Common Stumbling Block: Skipping it entirely to rush into development.

Building Core Requirement: Technical skills or capital.

Common Stumbling Block: Underestimating the amount of both needed for a viable MVP.

Launching Core Requirement: Marketing and distribution.
